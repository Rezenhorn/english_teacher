...
class StudentListView(SuperuserRequiredMixin, LoginRequiredMixin, ListView):
    model = User
    template_name = 'students/list.html'
    context_object_name = 'student_list'


class DictionaryListView(SuperuserOrAuthorMixin, LoginRequiredMixin, ListView):
...
class DictionaryCreateView(
    SuperuserOrAuthorMixin, LoginRequiredMixin, CreateView
        ):
...
class HomeworkUpdateView(
    SuperuserRequiredMixin, LoginRequiredMixin, UpdateView
        ):
    form_class = HomeworkForm
    model = Homework
    template_name = 'students/homework_form.html'
...
class HomeworkDeleteView(
    SuperuserRequiredMixin, LoginRequiredMixin, DeleteView
        ):
    model = Homework
