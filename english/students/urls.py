...
urlpatterns = [
    ...
    path(
        '<str:username>/add_homework/',
        views.HomeworkCreateView.as_view(),
        name='add_homework'
    ),
    path(
        '<str:username>/edit_homework/<int:homework_id>/',
        views.HomeworkUpdateView.as_view(),
        name='edit_homework'
    ),
    path(
        '<str:username>/delete_homework/<int:homework_id>/',
        views.HomeworkDeleteView.as_view(),
        name='delete_homework'
    ),
    path(
        '<str:username>/dictionary/',
        views.DictionaryListView.as_view(),
        name='dictionary'
    ),
    path(
        '<str:username>/dictionary/add_word/',
